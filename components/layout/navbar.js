...
function Navbar() {
    ...
    return (
        <nav className={classes.navbar} >
            ...
            <ul>
                {!activeUser && <Link href={{ pathname: "/auth" }} passHref><li className={classes.register}><a style={{ cursor: 'pointer' }}><i className="bi bi-person-plus-fill"></i>Регистрация</a></li></Link>}
