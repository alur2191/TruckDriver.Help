...
function Form() {
    ...
    return (
        <>
            ...
            >
                <div>
                    На период бета-тестирования размещение объявлений бесплатно. Администрация сайта регульярно рассматривает новые объявления. Просим указывать корректные данные, а также не размещать похожие объявления более чем один раз.
                </div>
